...
<tr>
	...
	<td><input type="text" name="e" id="e" value="<?php echo$row["nilai_mm"]; ?>" required="" minlength="1"></td>
	</tr>
	<tr>
	<td>Nilai Pkn</td><td><input type="text" name="f" id="f" value="<?php echo$row["nilai_pkn"]; ?>" required="" minlength="1"></td></tr>
<tr> 
<td></td>
...
if (isset($_POST['kirim'])) {
	...
	$nilai_mm=htmlspecialchars($_POST['e']);
	$nilai_pkn=htmlspecialchars($_POST['f']);
	
	$koneksi= new mysqli("localhost", "root", "", "mahasiswa");/* baris ini untuk menghubungkan kedatabase */
	$sql="UPDATE `datamahasiswa` SET 
	 npm='$npm', nama='$nama', nilai_bahasa='$nilai_bahasa', nilai_agama='$nilai_agama', nilai_mm='$nilai_mm', nilai_pkn='$nilai_pkn' WHERE npm=$npm
